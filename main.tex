...
\addbibresource{ReferenceMaster.bib}
...
\eauthor{
    \vspace{-15pt}
    松田 拓巳\textsuperscript{*1}
    % ，○正　名前 名前\textsuperscript{*2}，名前 名前\textsuperscript{*3}
    \\
    Takumi MATSUDA\textsuperscript{*1}
    % , Name NAME\textsuperscript{*2} and Name NAME\textsuperscript{*3}
}
% \email{}
% \jaffiliation{}
\eaffiliation{
    \textsuperscript{*1} 京都大学理学部　Faculty of Science, Kyoto University \\
    % \textsuperscript{*2} 所属　Affiliation \\
    % \textsuperscript{*3} 所属　Affiliation
}
% \date{}
...
\lhead{}
\chead{}
% \rhead{\textsf{\textgt{\footnotesize Copyright \copyright\ 20??　京都大学理学研究科　地球惑星科学専攻}}}  % 講演論文の場合はこちらにする。
\rhead{}  % 予稿の場合はこちらにする。
\lfoot{\textsf{\textgt{\footnotesize 京都大学理学研究科}}}
\cfoot{}
\rfoot{}
...
\newcommand{\bibref}[1]{\textsuperscript{(\ref{#1})}}
\makeatletter
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=96.2mm]{Figures/1.eps}
...
\printbibliography % 参考文献リストの出力

% \begin{thebibliography}{99}
% \item Ahrendt, W. R. and Taplin, J. F., Automatic Feedback Control (1951), p.12, McGraw-Hill.
% \item International Federation of Library Associations and Institutions, Digital libraries: Resources and project, IFLANET (online), available from 〈http://www.ifla.org/II/htm〉, (accessed on 30 November, 1999).
% \item Kameyama, H., Production method of thermal conductive catalyst, Japanese patent disclosure H00-100100 (1990).
% \item Karin, P. and Hanamura, K., Microscopic visualization of PM trapping and regeneration in a diesel particulate catalyst-membrane filter (DPMF), Transactions of Society of Automotive Engineers of Japan, Vol.41, No.1 (2010a), pp.103--108.
% \item Karin, P. and Hanamura, K., Microscopic visualization of particulate matter trapping and oxidation behaviors in a diesel particulate catalyst-membrane filter, Transactions of Society of Automotive Engineers of Japan, Vol.41, No.4 (2010b), pp.853--858.
% \item Keer, L. M., Lin, W. and Achenbach, J. D., Resonance effects for a crack near a free surface, Transactions of the ASME, Journal of Applied Mechanics, Vol.51, No.1 (1984), pp.65--70.
% \item Nagashima, A., New year's greeting, Journal of the Japan Society of Mechanical Engineers, Vol.108, No.1034 (2005), pp.1--2 (in Japanese).
% \item Tagawa, A. and Yamashita, T., Development of real time sensor for under sodium viewer, Proceedings of the 19th International Conference on Nuclear Engineering (ICONE-19) (2011), Paper No. ICONE19--43187.
% \item Takeuchi, S., Yamazaki, T. and Kajishima, T., Study of solid-fluid interaction in body-fixed non-inertial frame of reference, Journal of Fluid Science and Technology, Vol.1, No.1 (2006), pp.1--11.
% \item Takeuchi, Y., Ultraprecision micromilling technology, Transactions of the Japan Society of Mechanical Engineers, Series C, Vol.71, No.701 (2005), pp.1--4 (in Japanese).
% \item The Japan Society of Mechanical Engineers ed., JSME Data Handbook: Heat Transfer (1979), p.123, The Japan Society of Mechanical Engineers (in Japanese).
% \item Tsutahara, M., Tamura, A. and Kataoka, T., A study of SIS of surfactant by the finite difference lattice Boltzmann method, Proceedings of the 16th Computational Mechanics Conference (2003), pp.121--122 (in Japanese).
% \item Watanabe, T., Sakai, Y., Nagata, K., Terashima, O., Ito, Y. and Hayase, T., DNS of turbulent Schmidt number and eddy diffusivity for reactive concentrations, Transactions of the JSME (in Japanese), Vol. 80, No. 809 (2014), DOI:10.1299/transjsme.2014fe0008.
% \end{thebibliography}
\end{document}
